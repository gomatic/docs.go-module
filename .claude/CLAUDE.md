# `docs.go-module` — public documentation repository

This is the **public** documentation site for [`gomatic/go-module`](https://github.com/gomatic/go-module), created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages.
...
- **Keep docs in sync with the source.** When [`gomatic/go-module`](https://github.com/gomatic/go-module)'s API changes, update [`content/`](../content/) to match.
